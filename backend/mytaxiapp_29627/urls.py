"""mytaxiapp_29627 URL Configuration
...
admin.site.site_header = "myTaxiApp"
admin.site.site_title = "myTaxiApp Admin Portal"
admin.site.index_title = "myTaxiApp Admin"

# swagger
api_info = openapi.Info(
    title="myTaxiApp API",
    default_version="v1",
    description="API documentation for myTaxiApp App",
)
